...
var DataProvider = function (_Component) {
  ...
  function DataProvider() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = {
      ...
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(subDomain) {
        var current;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                ...
                _this.subDomainChangedTimeout = setTimeout(_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
  ...
  DataProvider.prototype.shouldComponentUpdate = function shouldComponentUpdate(_ref5, _ref6) {
    ...
    var allKeys = uniq([].concat(keys, currentKeys));
